...
function Snackbar(_ref) {
  ...
  // Snackbar's duration
  var _useState7 = React.useState(defaultDuration),
    _useState8 = _slicedToArray(_useState7, 2),
    duration = _useState8[0],
    setDuration = _useState8[1];
  // Snackbar's position
  var _useState9 = React.useState(defaultPosition),
  ...
  var _useState11 = React.useState({}),
    ...
    customStyles = _useState12[0],
    setCustomStyles = _useState12[1];
  // Custom styles for the close button
  var _useState13 = React.useState({}),
    _useState14 = _slicedToArray(_useState13, 2),
    closeCustomStyles = _useState14[0],
    setCloseCustomStyles = _useState14[1];
  var triggerSnackbar = function triggerSnackbar(text, duration, position, style, closeStyle) {
    setText(text);
  ...
  var openSnackbar = function openSnackbar(text, duration, position, style, closeStyle) {
  ...
  return /*#__PURE__*/React.createElement(SnackbarContext.Provider, {
  ...
  }, children, /*#__PURE__*/React.createElement(CSSTransition$1, {
    "in": open,
    timeout: 150,
    mountOnEnter: true,
    unmountOnExit: true
    ...
    ,
    className: "".concat(styles['snackbar-wrapper'], " ").concat(styles["snackbar-wrapper-".concat(position)]),
    classNames: {
      enter: "".concat(styles['snackbar-enter'], " ").concat(styles["snackbar-enter-".concat(position)]),
      enterActive: "".concat(styles['snackbar-enter-active'], " ").concat(styles["snackbar-enter-active-".concat(position)]),
      exitActive: "".concat(styles['snackbar-exit-active'], " ").concat(styles["snackbar-exit-active-".concat(position)])
    }
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: styles.snackbar,
    style: customStyles
  }, /*#__PURE__*/React.createElement("div", {
    className: styles.snackbar__text
...
var useSnackbar = function useSnackbar() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
    ...
    position = _ref$position === void 0 ? defaultPosition : _ref$position,
    _ref$style = _ref.style,
    style = _ref$style === void 0 ? {} : _ref$style,
    _ref$closeStyle = _ref.closeStyle,
    closeStyle = _ref$closeStyle === void 0 ? {} : _ref$closeStyle;
  var _useContext = React.useContext(SnackbarContext),
...
function withSnackbar(WrappedComponent) {
  ...
  return _Class = /*#__PURE__*/function (_React$Component) {
    ...
    return _createClass(_Class, [{
      ...
      value: function open() {
        var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
        var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultDuration;
        var openSnackbar = this.context.openSnackbar;
      ...
      value: function close() {
        var closeSnackbar = this.context.closeSnackbar;
        closeSnackbar();
      }
    }, {
      key: "render",
  ...
  }(React.Component), _defineProperty(_Class, "contextType", SnackbarContext), _Class;
}
